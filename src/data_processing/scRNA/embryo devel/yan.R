# Yan, L., Yang, M., Guo, H., Yang, L., Wu, J., Li, R., Liu, P., Lian, Y., Zheng, X., Yan, J. and Huang, J., 2013. Single-cell RNA-Seq profiling of human preimplantation embryos and embryonic stem cells. Nature structural & molecular biology, 20(9), pp.1131-1139.
...
### ANNOTATIONS
cl <- colnames(gset)
cl[grepl("Oocyte", cl)] <- "oocyte"
cl[grepl("Zygote", cl)] <- "zygote"
cl[grepl("2-cell", cl)] <- "2cell"
cl[grepl("4-cell", cl)] <- "4cell"
cl[grepl("8-cell", cl)] <- "8cell"
cl[grepl("Morulae", cl)] <- "morula"
cl[grepl("Late blastocyst", cl)] <- "lateblast"
cl[grepl("hESC passage#0", cl)] <- "hESCpassage0"
cl[grepl("hESC passage#10", cl)] <- "hESCpassage10"
classes <- data.frame(cell_type1 = cl)
...
# 0 (oocytes and embryos): "oocyte", "zygote", "2cell", "4cell", "8cell", "morula", and "lateblast"
# 1 (primary hESC outgrowth): "hESCpassage0" and "hESCpassage10"
gsms <- c(0, 0, 0, 0, 0, 0, 0, 1, 1)
