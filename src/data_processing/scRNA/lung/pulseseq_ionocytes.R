...
neg_ionocytes <- read.table(file.path(working_dir,
                                      paste("pulseseq_neg_subionocytes.txt", sep = "")),
                            header = FALSE, sep = ",", check.names = FALSE,
                            stringsAsFactors = FALSE)[, 1]
neg_ionocytes <- read.table(file.path(working_dir,
                                      paste("pulseseq_neg_subionocytes_extended.txt", sep = "")),
                            header = FALSE, sep = ",", check.names = FALSE,
                            stringsAsFactors = FALSE)[, 1]
...
gset <- t(gset)
gset[is.na(gset)] <- 0
file_name <- "pulseseq_ionocyte_vs_negfoxi1"
file_name <- "pulseseq_ionocyte_vs_negfoxi1_extended"
### LIMMA
