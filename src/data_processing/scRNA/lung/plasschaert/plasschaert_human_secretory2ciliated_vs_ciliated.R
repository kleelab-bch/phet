...
file_name <- "plasschaert_human_secretory2ciliated_vs_ciliated"
...
# keep Basal cells 
condition <- metadata %in% c("Secretory>Ciliated", "Ciliated")
...
enriched_features <- df$EnrichedIn %in% c("Secretory>Ciliated", "Ciliated")
...
# 0 (Secretory>Ciliated cells): "Secretory>Ciliated"
