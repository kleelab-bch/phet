...
file_name <- "plasschaert_human_basal2secretory_vs_secretory"
...
# keep Basal cells 
condition <- metadata %in% c("Basal>Secretory", "Secretory")
...
enriched_features <- df$EnrichedIn %in% c("Basal>Secretory", "Secretory")
