...
file_name <- "plasschaert_human_basaland2secretory_vs_secretory"
...
# keep Basal cells 
condition <- metadata %in% c("Basal", "Basal>Secretory", "Secretory")
...
enriched_features <- df$EnrichedIn %in% c("Basal", "Basal>Secretory", "Secretory")
...
# 0 (Basal & Basal>Secretory cells): "Basal" and "Basal>Secretory"
