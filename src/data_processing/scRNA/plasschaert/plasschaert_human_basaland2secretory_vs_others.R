...
file_name <- "plasschaert_human_basaland2secretory_vs_others"
...
# 1 (Other cells): "Secretory", "Secretory>Ciliated", "Ciliated", "FOXN4+",  "SLC16A7+", "Ionocyte", and "Brush+PNEC"
gsms <- c(1, 0, 1, 1, 0, 1, 1, 1, 1)
