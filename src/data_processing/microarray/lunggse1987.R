# Dehan, E., Ben-Dor, A., Liao, W., Lipson, D., Frimer, H., Rienstein, S., Simansky, D., Krupsky, M., Yaron, P., Friedman, E. and Rechavi, G., 2007. Chromosomal aberrations and gene expression profiles in non-small cell lung cancer. Lung cancer, 56(2), pp.175-184.
...
# 0: Normal lung tissue (Normal): 9 examples (26.5%)
# 1: Squamous cell carcinoma (Squamous) and Adenocarcinoma (Adenocarcinoma): 25 examples (73.5%)
gsms <- c(1, 1, 0)
