...
# 0: classic glioblastoma (CG) and classic oligodendroglioma (CO): 21 examples
# 1: nonclassic glioblastoma (NG) and oligodendroglioma (NO): 19 examples (28.0%)
gsms <- c(0, 0, 1, 1)
