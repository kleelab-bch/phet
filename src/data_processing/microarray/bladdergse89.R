# Dyrskjøt, L., Thykjaer, T., Kruhøffer, M., Jensen, J.L., Marcussen, N., Hamilton-Dutoit, S., Wolf, H. and Ørntoft, T.F., 2003. Identifying distinct classes of bladder carcinoma using microarrays. Nature genetics, 33(1), pp.90-96.
...
# 0: tumor stage Ta (Ta) and tumor stage T1 (T1): 30 examples
# 1: tumor stage T2-T4 (T2+): 10 examples (25.0%)
gsms <- c(1, 0, 0)
