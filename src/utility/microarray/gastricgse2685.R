# Hippo, Y., Taniguchi, H., Tsutsumi, S., Machida, N., Chong, J.M., Fukayama, M., Kodama, T. and Aburatani, H., 2002. Global gene expression analysis of gastric cancer by oligonucleotide microarrays. Cancer research, 62(1), pp.233-240.
...
# 0: normal gastric tissue (Normal): 8 examples (26.7%)
# 1: diffuse gastric tumor (Diffuse) and intestinal gastric tumor (Intestinal): 22 examples (73.3%)
gsms <- c(0, 1, 1)
