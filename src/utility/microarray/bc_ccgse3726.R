# Chowdary, D., Lathrop, J., Skelton, J., Curtin, K., Briggs, T., Zhang, Y., Yu, J., Wang, Y. and Mazumder, A., 2006. Prognostic gene expression signatures can be measured in tissues collected in RNAlater preservative. The journal of molecular diagnostics, 8(1), pp.31-39.
...
# 0: breast cancer (breast): 31 examples (59.6%)
# 1: colon cancer (colon): 21 examples (40.4%)
gsms <- c(0, 1)
