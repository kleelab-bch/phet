...
write.table(tT, file = file.path(working_dir, paste(file_name, "_features.csv", sep = "")),
            sep = ",", quote = FALSE, row.names = FALSE)
...
par(mar = c(7, 4, 2, 1))
title <- paste("GSE13159", "/", annotation(gset), sep = "")
...
par(mar = c(4, 4, 2, 1))
title <- paste("GSE13159", "/", annotation(gset), " value distribution", sep = "")
...
plotSA(fit2, main = "Mean variance trend, GSE13159")