...
# 0 (Basal cells): "Basal", "Cycling Basal (homeostasis)", "Cycling Basal (regeneration)", and "Krt4/13+"
# 1 (non Basal cells): "Secretory", "Pre-ciliated", "Ciliated", "Brush", "PNEC", and "Ionocytes"                
gsms <- c(1, 0, 1, 1, 1, 0, 0, 1, 0, 1)
