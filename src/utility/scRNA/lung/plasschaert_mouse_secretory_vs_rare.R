...
# remove Basal cells 
condition <- !metadata %in% c("Basal", "Cycling Basal (homeostasis)", "Cycling Basal (regeneration)")
...
enriched_features <- !df$EnrichedIn %in% c("Basal", "Basal & Cycling basal pooled",
                                           "Cycling Basal")
