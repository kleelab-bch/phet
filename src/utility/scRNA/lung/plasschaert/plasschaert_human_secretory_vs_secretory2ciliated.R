...
file_name <- "plasschaert_human_secretory_vs_secretory2ciliated"
...
# keep Basal cells 
condition <- metadata %in% c("Secretory", "Secretory>Ciliated")
...
enriched_features <- df$EnrichedIn %in% c("Secretory", "Secretory>Ciliated")
...
# 1 (Secretory>Ciliated cells): "Secretory>Ciliated"
gsms <- c(1, 0)
