...
file_name <- "plasschaert_mouse_basalandpreciliated_vs_ciliated"
...
# remove Basal cells 
condition <- metadata %in% c("Basal", "Pre-ciliated", "Ciliated")
...
enriched_features <- df$EnrichedIn %in% c("Basal", "Pre-ciliated", "Ciliated")
...
# 0 (Basal and Pre-ciliated cells): "Basal" and "Pre-ciliated"
# 1 (Ciliated): "Ciliated"                
gsms <- c(0, 1, 0)
